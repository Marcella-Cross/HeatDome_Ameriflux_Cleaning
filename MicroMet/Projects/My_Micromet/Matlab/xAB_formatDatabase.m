...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-xAB_BASE_HH_9-5.csv');
...
pth = biomet_path('yyyy','XAB','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'XAB';
structSetup.SiteID = 'XAB';
...
fr_automated_cleaning([2020, 2021, 2022], 'XAB', 1);
%% Once second stage ini file has been created:
fr_automated_cleaning([2020, 2021, 2022], 'XAB', 2);
%%
fr_automated_cleaning([2020, 2021, 2022], 'XAB', [7 8]);