...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_CA-LP1_BASE_HH_4-5.csv');
...
pth = biomet_path('yyyy','LP1','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'LP1';
structSetup.SiteID = 'LP1';
...
fr_automated_cleaning([2020, 2021, 2022], 'LP1', 1);

%% Once second stage ini file has been created:
fr_automated_cleaning([2020, 2021, 2022], 'LP1', 2);
%%
fr_automated_cleaning([2020, 2021, 2022], 'LP1', [7 8]);