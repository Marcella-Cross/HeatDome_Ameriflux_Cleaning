...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-CF4_BASE_HH_3-5.csv');
...
pth = biomet_path('yyyy','CF4','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'CF4';
structSetup.SiteID = 'CF4';
