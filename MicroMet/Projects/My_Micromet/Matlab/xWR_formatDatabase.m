...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-xWR_BASE_HH_9-5.csv');
...
pth = biomet_path('yyyy','XWR','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'XWR';
structSetup.SiteID = 'XWR';
...
fr_automated_cleaning([2020, 2021, 2022], 'XWR', 1);
