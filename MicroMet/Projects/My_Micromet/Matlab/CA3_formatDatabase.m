...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_CA-Ca3_BASE_HH_6-5.csv');
...
pth = biomet_path('yyyy','CA3','MET');                   % find data base path for multiple years, BB2 site
...
fr_automated_cleaning([2020, 2021, 2022], 'CA3', 1);
%% Once second stage ini file has been created:
fr_automated_cleaning([2020, 2021, 2022], 'CA3', 2);
