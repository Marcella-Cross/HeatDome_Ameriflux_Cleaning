...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-Me2_BASE_HH_19-5.csv');
...
pth = biomet_path('yyyy','Me2','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'ME2';
structSetup.SiteID = 'ME2';
...
fr_automated_cleaning([2020, 2021, 2022],'ME2',1)

%% Once second stage ini file has been created:
fr_automated_cleaning([2020, 2021, 2022],'ME2',2)
%% Once second stage ini file has been created:
fr_automated_cleaning([2020, 2021, 2022], 'ME2', [7 8]);