...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-CF3_BASE_HH_3-5.csv');
...
%% Above this point is where the flux file gets saved in the database - below this is for met files 
...
pth = biomet_path('yyyy','CF3','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'CF3';
structSetup.SiteID = 'CF3';
...
fr_automated_cleaning([2020, 2021, 2022], 'CF3', 1);

%% Once second stage ini file has been created:
fr_automated_cleaning([2020, 2021, 2022], 'CF3', 2);
fr_automated_cleaning([2020, 2021, 2022], 'CF3', [7 8]);