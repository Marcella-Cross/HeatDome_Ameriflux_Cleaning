...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-CF2_BASE_HH_2-5.csv');
...
pth = biomet_path('yyyy','CF2','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'CF2';
structSetup.SiteID = 'CF2';
...
fr_automated_cleaning([2020, 2021, 2022], 'CF2', 1);
