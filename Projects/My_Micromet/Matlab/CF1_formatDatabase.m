...
%
% Input file name
fileName = fullfile(structProject.sitesPath, siteID, 'Flux','AMF_US-CF1_BASE_HH_3-5.csv');
...
pth = biomet_path('yyyy','CF1','MET');                   % find data base path for multiple years, BB2 site
...
structSetup.Site_name = 'CF1';
structSetup.SiteID = 'CF1';
...
fr_automated_cleaning([2020, 2021, 2022], 'CF1', 1);
